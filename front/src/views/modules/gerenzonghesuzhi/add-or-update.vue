    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="专业" prop="zhuanyeValue">
                        <el-input v-model="xueshengForm.zhuanyeValue"
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="思想道德水平" prop="sixiangdaode">
                       <el-input v-model="ruleForm.sixiangdaode"
                                 placeholder="思想道德水平" clearable  :readonly="ro.sixiangdaode"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="思想道德水平" prop="sixiangdaode">
                           <el-input v-model="ruleForm.sixiangdaode"
                                     placeholder="思想道德水平" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学业综合宿舍" prop="xueye">
                       <el-input v-model="ruleForm.xueye"
                                 placeholder="学业综合宿舍" clearable  :readonly="ro.xueye"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学业综合宿舍" prop="xueye">
                           <el-input v-model="ruleForm.xueye"
                                     placeholder="学业综合宿舍" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身心健康" prop="shenxinjiankang">
                       <el-input v-model="ruleForm.shenxinjiankang"
                                 placeholder="身心健康" clearable  :readonly="ro.shenxinjiankang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="身心健康" prop="shenxinjiankang">
                           <el-input v-model="ruleForm.shenxinjiankang"
                                     placeholder="身心健康" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="艺术素养" prop="yishusuyang">
                       <el-input v-model="ruleForm.yishusuyang"
                                 placeholder="艺术素养" clearable  :readonly="ro.yishusuyang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="艺术素养" prop="yishusuyang">
                           <el-input v-model="ruleForm.yishusuyang"
                                     placeholder="艺术素养" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="社会综合实践" prop="shehuizongheshijian">
                       <el-input v-model="ruleForm.shehuizongheshijian"
                                 placeholder="社会综合实践" clearable  :readonly="ro.shehuizongheshijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="社会综合实践" prop="shehuizongheshijian">
                           <el-input v-model="ruleForm.shehuizongheshijian"
                                     placeholder="社会综合实践" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.gerenzonghesuzhiContent"  label="备注" prop="gerenzonghesuzhiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gerenzonghesuzhiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gerenzonghesuzhiContent" label="备注" prop="gerenzonghesuzhiContent">
                            <span v-html="ruleForm.gerenzonghesuzhiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    sixiangdaode: false,
                    xueye: false,
                    shenxinjiankang: false,
                    yishusuyang: false,
                    shehuizongheshijian: false,
                    gerenzonghesuzhiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                ...
                rules: {
                   ...
                   sixiangdaode: [
                              { required: true, message: '思想道德水平不能为空', trigger: 'blur' },
                   ...
                   xueye: [
                              { required: true, message: '学业综合宿舍不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   shenxinjiankang: [
                              { required: true, message: '身心健康不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   yishusuyang: [
                              { required: true, message: '艺术素养不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   shehuizongheshijian: [
                              { required: true, message: '社会综合实践不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`gerenzonghesuzhi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gerenzonghesuzhiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
