...
import center from '@/views/center'
    ...
    import gerenzonghesuzhi from '@/views/modules/gerenzonghesuzhi/list'
    import gonggao from '@/views/modules/gonggao/list'
    import laoshi from '@/views/modules/laoshi/list'
    import liuyan from '@/views/modules/liuyan/list'
    import xuesheng from '@/views/modules/xuesheng/list'
    import zhuanyezonghesuzhi from '@/views/modules/zhuanyezonghesuzhi/list'
...
const routes = [{
    ...
    ,{
        path: '/gerenzonghesuzhi',
        name: '个人综合素质',
        component: gerenzonghesuzhi
      }
    ,{
        path: '/gonggao',
        name: '公告',
    ...
    ,{
        path: '/zhuanyezonghesuzhi',
        name: '专业综合素质',
        component: zhuanyezonghesuzhi
      }
