<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="专业编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="专业编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="专业编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="专业编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="专业" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="专业" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="专业" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="zhuanye_types";
                        ruleForm["dicName"]="专业";
                        this.$http({
