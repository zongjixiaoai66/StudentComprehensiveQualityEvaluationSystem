    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="留言名称" prop="liuyanName">
                       <el-input v-model="ruleForm.liuyanName"
                                 placeholder="留言名称" clearable  :readonly="ro.liuyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="留言名称" prop="liuyanName">
                           <el-input v-model="ruleForm.liuyanName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="留言类型" prop="liuyanTypes">
                        <el-select v-model="ruleForm.liuyanTypes" :disabled="ro.liuyanTypes" placeholder="请选择留言类型">
                            <el-option
                                v-for="(item,index) in liuyanTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="留言类型" prop="liuyanValue">
                        <el-input v-model="ruleForm.liuyanValue"
                            placeholder="留言类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.liuyanFile" label="留言附件" prop="liuyanFile">
                        <file-upload
                                tip="点击上传留言附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.liuyanFile?ruleForm.liuyanFile:''"
                                @change="liuyanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.liuyanFile" label="留言附件" prop="liuyanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.liuyanFile"  >留言附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.liuyanContent"  label="留言内容" prop="liuyanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.liuyanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.liuyanContent" label="留言内容" prop="liuyanContent">
                            <span v-html="ruleForm.liuyanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="!(sessionTable=='xuesheng' && type!='info')">
                    <el-form-item v-if="type!='info' && !ro.huifuContent"  label="回复内容" prop="huifuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   liuyanFile: [
                              { required: true, message: '留言附件不能为空', trigger: 'blur' },
                          ],
                   liuyanContent: [
        ...
        created() {
            ...
            if (this.role == "辅导员" || this.role == '老师'){
                    this.ro.xueshengId = true;
                    this.ro.liuyanName = true;
                    this.ro.liuyanTypes = true;
                    this.ro.liuyanFile = true;
                    this.ro.liuyanContent = true;
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=liuyan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.liuyanTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            //图片
            liuyanFileUploadChange(fileUrls){
                this.ruleForm.liuyanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
