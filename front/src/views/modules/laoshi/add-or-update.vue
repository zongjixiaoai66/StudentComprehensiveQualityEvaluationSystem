               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师姓名" prop="laoshiName">
                       <el-input v-model="ruleForm.laoshiName"
                                 placeholder="老师姓名" clearable  :readonly="ro.laoshiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师手机号" prop="laoshiPhone">
                       <el-input v-model="ruleForm.laoshiPhone"
                                 placeholder="老师手机号" clearable  :readonly="ro.laoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师身份证号" prop="laoshiIdNumber">
                       <el-input v-model="ruleForm.laoshiIdNumber"
                                 placeholder="老师身份证号" clearable  :readonly="ro.laoshiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laoshiPhone: [
                              {  required: true, message: '老师手机号不能为空', trigger: 'blur' },
                   ...
                   laoshiIdNumber: [
                              { required: true, message: '老师身份证号不能为空', trigger: 'blur' },
                   ...
                   laoshiPhoto: [
                              { required: true, message: '老师头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
