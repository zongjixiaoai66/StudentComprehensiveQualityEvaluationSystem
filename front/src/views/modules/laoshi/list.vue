                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zonghesuzhipingjiaxitong/upload/laoshiMuBan.xls"
                        >批量导入老师数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('laoshi','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'laoshi',//当前表表名,
                        sumColum : 'laoshi_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'laoshi_name',//分组字符串字段
                        // types : 'laoshi_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
