  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='fudaoyuan'" label='辅导员头像' prop="fudaoyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='fudaoyuan'"  label='电子邮箱' prop="fudaoyuanEmail">
               <el-input v-model="ruleForm.fudaoyuanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='fudaoyuan'"  label='班级' prop="banjiTypes">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='laoshi'"  label='班级' prop="banjiTypes">
                 <el-select v-model="ruleForm.banjiTypes"  placeholder='请选择班级'>
                     <el-option
                             v-for="(item,index) in banjiTypesOptions"
                             v-bind:key="item.codeIndex"
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.banjiTypes)&& 'fudaoyuan'==this.flag){
                         ...
                         if((!this.ruleForm.banjiTypes)&& 'laoshi'==this.flag){
                             this.$message.error('班级不能为空');
                             return
                         }
